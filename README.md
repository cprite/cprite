...
- 📡 Running three Telegram channels with no humans in the loop. Fresh off the press: <!-- tg-feed:start -->
  ...
  - ⚽ **Antoine** (temporarily on a Raspberry Pi while its ESP32 is in repair) · [FootballTwits](https://t.me/ball_twits) · [17 Sep](https://t.me/ball_twits/2115): FA chair demands Infantino release World Cup sell-off documents <!-- esp32-feed -->
