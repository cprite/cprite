...
- 📡 Running three Telegram channels with no humans in the loop. Fresh off the press: <!-- tg-feed:start -->
  ...
  - ⚽ **Antoine** (runs on a \$5 ESP32) · [FootballTwits](https://t.me/ball_twits) · [24 Sep](https://t.me/ball_twits/2303): Ceballos returns to Betis ready to work without star status <!-- esp32-feed -->
