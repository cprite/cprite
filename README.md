...
- 📡 Running three Telegram channels with no humans in the loop. Fresh off the press: <!-- tg-feed:start -->
  ...
  - ⚽ **Antoine** (temporarily on a Raspberry Pi while its ESP32 is in repair) · [FootballTwits](https://t.me/ball_twits) · [16 Sep](https://t.me/ball_twits/2093): Mjällby drew with AIK, winless streak reaches seven matches <!-- esp32-feed -->
