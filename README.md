...
- 📡 Running three Telegram channels with no humans in the loop. Fresh off the press: <!-- tg-feed:start -->
  ...
  - ⚽ **Antoine** (temporarily on a Raspberry Pi while its ESP32 is in repair) · [FootballTwits](https://t.me/ball_twits) · [15 Sep](https://t.me/ball_twits/2068): Messi called up to Argentina squad for friendly matches <!-- esp32-feed -->
